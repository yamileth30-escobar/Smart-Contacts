  ...
  public partial class MainForm : Form
  {
    ...
    private void respaldoDeDatosToolStripMenuItem1_Click(object sender, EventArgs e)
    {
      try
      {
        ...
        using (System.Data.SqlClient.SqlConnection con = conector.ObtenerConexion())
        {
          System.Data.SqlClient.SqlCommand cmd = new System.Data.SqlClient.SqlCommand(comando, con);
          con.Open();
          cmd.ExecuteNonQuery();
    ...
    {
      // Este código avisa que la ventana se está construyendo
      MessageBox.Show("El módulo de Gestión de Categorías se encuentra en desarrollo para la Versión 1.1", "Smart Contacts", MessageBoxButtons.OK, MessageBoxIcon.Information);
    }
